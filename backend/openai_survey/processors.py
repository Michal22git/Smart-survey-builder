...
class SurveyProcessor:
    ...
    @staticmethod
    @transaction.atomic
    def create_survey_from_schema(survey_schema: SurveySchema, prompt: str) -> Dict[str, Any]:
        """
    ...
    @staticmethod
    def analyze_survey_results(survey_id: int, max_responses: int = 100) -> Dict[str, Any]:
        """
